...
# TODO: need an argparser?
# TODO: check for typing and formatting issues, usie make lint?
if __name__ == "__main__":
    ...
    print(
        f"You will see a board below with {rows * cols} squares containing numbers 1 to {rows * cols - 1} and an empty square, all randomly mixed."
    )
    print(
